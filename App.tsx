  ...
  return (
    <div className="min-h-screen bg-white text-black dark:bg-black dark:text-white font-sans selection:bg-primary selection:text-white overflow-x-hidden relative">
      ...
      <div className="flex w-full">
        {/* Main Content Area */}
        <main className="flex-1 flex flex-col relative z-10 pl-6 pr-[calc(4rem+env(safe-area-inset-right))] md:pl-20 md:pr-[calc(6rem+env(safe-area-inset-right))] pt-12 pb-12">
