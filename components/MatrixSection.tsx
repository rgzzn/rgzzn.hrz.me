...
const MatrixSection: React.FC = () => {
  return (
    <section id="profile" className="max-w-6xl mx-auto w-full mb-32 grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
      <div className="md:col-span-7">
        ...
        <p className="text-3xl md:text-5xl leading-[1.2] mb-10 tracking-tight font-medium text-black dark:text-white">
          "Visione <span className="font-serif italic font-normal text-4xl md:text-6xl text-black dark:text-white mr-1">full-stack</span> 
          dall'hardware al brand, con <span className="font-mono bg-primary text-white px-2 py-0.5 text-2xl md:text-4xl selection:bg-black selection:text-white inline-block transform -rotate-1 mt-2 md:mt-0">zero fuffa</span>."
        </p>
        <div className="text-lg opacity-80 max-w-xl font-mono leading-relaxed border-l-2 border-primary pl-4 space-y-3">
          <p>01. Responsabilità end-to-end su infrastruttura, sicurezza e decisioni critiche.</p>
          <p>02. Analisi log, XDR, PowerShell e automazione di task ripetitivi.</p>
          <p>03. Documentazione tecnica chiara, replicabile, orientata al risultato.</p>
        </div>
      </div>
      ...
      <div className="md:col-span-5 flex flex-col items-center justify-center p-8 bg-neutral-50 dark:bg-black-soft rounded-none border border-black/10 dark:border-white/10 aspect-square relative overflow-hidden">
        ...
        <div className="relative w-full h-full max-w-[280px] max-h-[280px]">
          ...
          <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] font-mono font-bold tracking-widest uppercase opacity-40 animate-enter-up delay-200">IT</div>
          <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 text-[10px] font-serif italic font-bold tracking-widest uppercase text-primary animate-enter-up delay-200">Media</div>
          ...
          <div className="absolute -right-8 top-1/2 -translate-y-1/2 writing-vertical-rl text-[10px] font-mono font-bold tracking-widest uppercase opacity-40 animate-enter-up delay-200">Growth</div>
          ...
          {/* Quadrant Labels */}
          <div className="absolute top-4 left-4 text-[9px] font-mono opacity-0 animate-enter-up delay-500">Security</div>
          ...
          <div className="absolute bottom-1/4 left-8 text-[9px] font-serif italic opacity-0 animate-enter-up delay-500">Responsibility</div>
        </div>
      </div>
    </section>
  );
