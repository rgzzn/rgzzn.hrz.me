  ...
  return (
    <section className="max-w-4xl mx-auto w-full mb-40 relative pl-4 md:pl-0">
      ...
      <div className="relative ml-2 md:ml-0 space-y-20">
        ...
        <div className="absolute left-0 top-0 w-[2px] bg-black/20 h-full origin-top animate-grow-h"></div>

        {/* Item 1 */}
        <div className="relative pl-8 md:pl-16 group opacity-0 animate-enter-up delay-200">
          <div className="absolute -left-[9px] top-2 w-4 h-4 rounded-full bg-primary border-2 border-black group-hover:scale-125 transition-transform z-10"></div>
          ...
          <span className="font-mono text-xs border border-black px-2 py-0.5 mb-4 inline-block opacity-60">COMEGA // Forlì</span>
          <p className="font-serif italic text-xl leading-relaxed opacity-90 max-w-lg border-l-2 border-black pl-4">
        ...
        {/* Item 2 */}
        <div className="relative pl-8 md:pl-16 group opacity-0 animate-enter-up delay-300">
          <div className="absolute -left-[9px] top-2 w-4 h-4 rounded-full bg-black border-2 border-black group-hover:scale-125 transition-transform z-10"></div>
          <span className="font-mono text-sm font-bold opacity-60 mb-2 block">May 2023 — Present</span>
          <h4 className="text-2xl md:text-4xl font-bold uppercase mb-4 tracking-tight">IT Manager</h4>
          <span className="font-mono text-xs border border-black px-2 py-0.5 mb-4 inline-block opacity-60">BIPRES S.p.A. // Italia</span>
        ...
        {/* Item 3 */}
        <div className="relative pl-8 md:pl-16 group opacity-0 animate-enter-up delay-500">
          <div className="absolute -left-[9px] top-2 w-4 h-4 rounded-full bg-primary border-2 border-black group-hover:scale-125 transition-transform z-10"></div>
          ...
          <span className="font-mono text-xs border border-black px-2 py-0.5 mb-4 inline-block opacity-60">BIPRES S.p.A. // Portico di Romagna</span>
          <p className="font-serif italic text-xl leading-relaxed opacity-90 max-w-lg border-l-2 border-black pl-4">
