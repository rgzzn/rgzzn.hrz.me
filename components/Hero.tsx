  ...
  return (
    <header className="flex justify-between items-start mb-24 md:mb-32 relative">
      <div className="max-w-5xl relative z-10">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[0.9] uppercase text-black">
          ...
          <div className="flex flex-wrap items-baseline gap-2 opacity-0 animate-enter-up delay-200">
            <span className="font-mono text-4xl md:text-6xl lg:text-7xl align-baseline opacity-100 bg-black text-white px-2 hover:bg-primary transition-colors duration-500">
              MACHINES
            </span> 
            <span>AND</span>
            <span className="font-serif italic font-normal lowercase tracking-normal text-primary flex items-center gap-2">
              minds.
              <Asterisk className="w-8 h-8 md:w-12 md:h-12 animate-spin-slow text-black opacity-50" />
            </span>
          </div>
        </h1>
      ...
      <div className="hidden md:flex flex-col items-center gap-2 mt-4 opacity-0 animate-enter-up delay-500 animate-float-delayed">
        ...
        <div className="relative w-12 h-24 bg-black/5 rounded-full border-2 border-black p-1 flex flex-col justify-between hover:bg-black/5 transition-colors cursor-pointer group">
          <div className="w-full aspect-square bg-black rounded-full shadow-lg transform translate-y-0 group-hover:translate-y-12 transition-transform duration-500 ease-in-out" />
          <div className="absolute inset-0 flex flex-col justify-center items-center pointer-events-none opacity-20">
            <div className="w-0.5 h-1.5 bg-black mb-1"></div>
            <div className="w-0.5 h-1.5 bg-black mt-1"></div>
          </div>
        </div>
