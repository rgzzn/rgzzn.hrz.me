...
const workItems: WorkItem[] = [
  ...
  },
  {
    ...
    description: "DashB è una dashboard in stile bento progettata per trasformare Apple TV in un centro di controllo minimale ed elegante. Un\'unica interfaccia immersiva integra meteo in tempo reale, agenda personale e feed informativa, con un design ottimizzato per leggibilità da distanza e navigazione tramite telecomando. Sviluppata interamente in SwiftUI per tvOS, combina performance native, sicurezza dei dati e un'architettura modulare pensata per l'estenibilità futura.",
    highlights: [
      'Integrazione con Apple WeatherKit con aggiornamento automatico e gestione intelligente della posizione',
      'Aggregazione eventi da Google Calendar e Microsoft Outlook tramite OAuth Device Flow',
      'Lettura feed RSS con immagini, parsing dinamico e generazione QR code per apertura rapida da mobile',
      'Layout bento TV-Friendly con alto contrasto, tipografia ottimizzata e animazioni fluide',
      'Gestione sicura dei token tramite Keychain e flussi di autenticazione dedicati tramite tvOS',
    ],
